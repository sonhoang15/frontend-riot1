...
import img1 from '../../../assets/images/lol-esports-kv-2023.png';
import img2 from '../../../assets/images/val.png';
import logo1 from '../../../assets/logo/lol-esports-logo-full.png';
import logo2 from '../../../assets/logo/vct-logo-v-full-rgb-white.png';
class Esports extends Component {
    ...
    render() {
        ...
        return (
            <div className="section-Esports">
                <div className="Esports-block">
                    <div className="container-Esports-block">
                        <div class="our-Esports__title"><h2><FormattedMessage id="ALL.Esports" /></h2>
                        </div>
                        <div class="our-Esports__wrapper">
                            <ul class="our-Esports__list ">
                                <li class="our-Esports__item">
                                    <div class="Esports-card" onClick={() => this.handleViewInforPage('Q1')}>
                                        <a class="Esports-card_link" target="_blank">
                                            <img src={img1} />
                                        </a>
                                        <div class="Esports-card__content">
                                            <div class="Esports-card__logo">
                                                <img src={logo1} />
                                            </div>
                                            <div class="Esports-card-description">
                                                <p>
                                                </p>
                                                <div class="Esports-card-platforms">
                                ...
                                <li class="our-Esports__item">
                                    <div class="Esports-card" onClick={() => this.handleViewInforPage('Q2')}>
                                        <a class="Esports-card_link" target="_blank">
                                            <img src={img2} />
                                        </a>
                                        <div class="Esports-card__content">
