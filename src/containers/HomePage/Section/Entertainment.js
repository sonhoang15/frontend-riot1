...
import img1 from '../../../assets/images/arcane-card.png';
import img2 from '../../../assets/images/riot-music-card.png';
import logo1 from '../../../assets/logo/arcane-logo-white.png';
import logo2 from '../../../assets/logo/riotgames-music.png';
        ...
        return (
            <div className="section-Entertainment">
                <div className="Entertainment-block">
                    <div className="container-Entertainment-block">
                        <div class="our-Entertainment__title"><h2><FormattedMessage id="ALL.Entertainment" /></h2>
                        </div>
                        <div class="our-Entertainment__wrapper">
                            <ul class="our-Entertainment__list ">
                                <li class="our-Entertainment__item">
                                    <div class="Entertainment-card" onClick={() => this.handleViewInforPage('E1')}>
                                        <a class="Entertainment-card_link" target="_blank">
                                            <img src={img1} />
                                        </a>
                                        <div class="Entertainment-card__content">
                                            <div class="Entertainment-card__logo">
                                                <img src={logo1} />
                                            </div>
                                            <div class="Entertainment-card-description">
                                                <p>
                                                </p>
                                                <div class="Entertainment-card-platforms">
                                ...
                                <li class="our-Entertainment__item">
                                    <div class="Entertainment-card" onClick={() => this.handleViewInforPage('E2')}>
                                        <a class="Entertainment-card_link" target="_blank">
                                            <img src={img2} />
                                        </a>
                                        <div class="Entertainment-card__content">
