...
class HeaderInforPages extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isFormOpen: false,
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <div className="home-header-banner-infor">
                    <div className="header-infor">
                        <div className="riotbar-transparent-infor">
                            <div className="home-header-container-infor header">
                                <div className="home-header-content-infor">
                                        ...
                                        <a className="logo-desginer" onClick={this.toggleClick}>
                                            <div className="logo-1">
                                                <svg
                                                    width="85"
                                                    height="27"
                                                    class="_4QbmucHkCfNI1ob1rB2Twg== logo-riot"
                                            ...
                                            <div class="riotbar-app-switcher-trigger-arrow">
                                                <svg viewBox="0 0 8 5">
...
export default connect(mapStateToProps, mapDispatchToProps)(HeaderInforPages);
